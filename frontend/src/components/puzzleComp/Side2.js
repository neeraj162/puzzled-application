...
export default function Side2() {
    ...
    return (
        <div style={styles}>
            <div style={card}>
                {/* <h1>Side-2</h1> */}
                <h3 style={{ fontFamily: 'HARRYP_', fontSize: '45px' }}> Largest 3 digit prime number</h3>
                <form onSubmit={handleclick} style={{ marginTop: '50px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <input type="text"
